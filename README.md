...
В пункте 11. Дополнительное задание представлен гипотетический сценарий высокой нагрузки и падения производительности:

**Условие задачи:**  
Системой одновременно пользуются 100 000 пользователей, а список из большого количества заявок загружается 5–10 секунд.

**Требуется от кандидата:**  
Описать основные причины такой задержки и предложить архитектурные и технические решения проблемы.

**Мой ответ:**  
Я бы сначала проверил базу и SQL-запросы. Скорее всего, проблема может быть в большом количестве данных и отсутствии пагинации или индексов. Добавил бы пагинацию, оптимизировал запросы и индексы. При очень большой нагрузке использовал бы Redis, несколько backend-серверов и балансировщик. После этого обязательно сделал бы нагрузочное тестирование.
